...
@ApplicationScoped
@DenyAll
public class AsyncDenyAllTools {

    @DenyAll
    @Tool(name = "denyAllAsyncClass_echoDenyAll", title = "Echoes the input", description = "Returns the input unchanged")
    public CompletionStage<String> denyAllAsyncClass_echoDenyAll(@ToolArg(name = "input", description = "input to echo") String input) {
        return CompletableFuture.completedStage(input);
    }

    @RolesAllowed("Admins")
    @Tool(name = "denyAllAsyncClass_echoAdminAllowed", title = "Echoes the input", description = "Returns the input unchanged")
    public CompletionStage<String> denyAllAsyncClass_echoAdminAllowed(@ToolArg(name = "input", description = "input to echo") String input) {
        return CompletableFuture.completedStage(input);
    }
