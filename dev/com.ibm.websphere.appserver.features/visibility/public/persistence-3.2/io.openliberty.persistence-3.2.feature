...
symbolicName=io.openliberty.persistence-3.2
visibility=public
singleton=true
...
-bundles=io.openliberty.persistence.3.2.thirdparty; location:=dev/api/third-party/; mavenCoordinates="org.eclipse.persistence:eclipselink:5.0.0", \
